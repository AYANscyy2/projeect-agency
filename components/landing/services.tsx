    ...
    <section ref={containerRef} className="bg-surface py-20 md:py-32 w-full">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        <div className="mb-12 md:mb-16">
          ...
          <h3 className="font-anton text-[56px] md:text-[80px] uppercase text-primary leading-[0.9] reveal-text">What We Do.</h3>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 md:gap-8 lg:gap-12">
          
          {/* Card 1 */}
          <div className="relative group h-full">
            <div className="absolute top-0 left-0 w-full h-full bg-primary translate-x-3 translate-y-3 md:translate-x-4 md:translate-y-4 z-0 transition-transform group-hover:translate-x-5 group-hover:translate-y-5"></div>
            <div className="relative z-10 bg-white border-2 border-primary p-8 md:p-10 h-full flex flex-col gap-8 transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1">
               ...
               <div>
                 <h4 className="font-anton text-[32px] uppercase text-primary mb-3 leading-none reveal-text">Web Platforms</h4>
          ...
          <div className="relative group h-full">
            ...
            <div className="relative z-10 bg-white border-2 border-primary p-8 md:p-10 h-full flex flex-col gap-8 transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1">
               ...
               <div>
                 <h4 className="font-anton text-[32px] uppercase text-primary mb-3 leading-none reveal-text">Mobile Apps</h4>
                 <p className="font-inter text-[16px] text-on-surface-variant leading-relaxed reveal-text">
          ...
          <div className="relative group h-full">
            ...
            <div className="relative z-10 bg-white border-2 border-primary p-8 md:p-10 h-full flex flex-col gap-8 transition-transform group-hover:-translate-y-1 group-hover:-translate-x-1">
               ...
               <div>
                 <h4 className="font-anton text-[32px] uppercase text-primary mb-3 leading-none reveal-text">Cloud Systems</h4>
                 <p className="font-inter text-[16px] text-on-surface-variant leading-relaxed reveal-text">
