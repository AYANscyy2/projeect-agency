    ...
    <main ref={container} className="flex-1 opacity-0  max-w-[1400px] mx-auto w-full px-6 md:px-12 py-16 md:py-24 flex flex-col justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="flex flex-col gap-6 md:gap-8">
          <h1 ref={mainHeaad} className="overflow-hidden font-anton text-[32px] sm:text-[48px] md:text-[72px] lg:text-[104px] leading-[0.95] uppercase text-primary tracking-[-0.02em]">
            WE BUILD
            SOFTWARE THAT
            WORKS FOR YOUR
            BUSINESS.
          </h1>
          <p ref={para} className="font-inter text-[16px] md:text-[20px] text-on-surface-variant max-w-[540px] leading-[1.6]">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-2">
            <Button
              variant="primary"
              className="w-full sm:w-auto px-8 py-4 flex items-center justify-center gap-3 group text-[14px] tracking-widest"
        ...
        <div ref={img} className="relative translate-y-50 opacity-0 mt-8 lg:mt-0 w-full max-w-[560px] mx-auto lg:ml-auto">
          {/* Offset Black Square */}
          <div className="absolute top-3 -right-3 md:top-4 md:-right-4 lg:top-6 lg:-right-6 w-full h-full bg-primary z-0"></div>
